...
export default function Home() {
  ...
  return (
      <div
        ...
        className="scroll-container relative snap-mandatory h-screen w-screen overflow-y-scroll"
      >
        <i
          className={`fixed bottom-[16px] right-[16px] Icon z-[1000] p-2 text-[32px] hover:scale-[1.2] hover:bg-[#4b4b4b] rounded-[50%] btn ${activeIndex === 0 ? "opacity-0" : "animate-pulse"} `}
        ...
        {backgroundImages.map((image, index) => (
          <img
            ...
            className={`w-screen h-screen z-[-1] fixed mt-[0px] transition-opacity blur-md duration-500 scale-[1.1] overflow-hidden ${
